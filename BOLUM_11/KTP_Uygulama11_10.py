...
AD,SOYAD,TELEFON_NUMARASI verileri alınıyor. soyadından AZALAN sıralı durumda"""
import sqlite3
baglanti=sqlite3.connect('C:/Python/Python_Kitap/DB/ogrenciler.db')
baglanti.row_factory=sqlite3.Row
isaretci=baglanti.cursor()
db=isaretci.execute("SELECT adi,soyadi,telefon_numarasi FROM ogrenciler ORDER BY soyadi DESC")
